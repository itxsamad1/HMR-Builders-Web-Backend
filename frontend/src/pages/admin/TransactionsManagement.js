          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatPrice(transactionsData?.data?.summary?.totalDeposits || 0)}
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatPrice(transactionsData?.data?.summary?.totalWithdrawals || 0)}
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {transactionsData?.data?.summary?.pendingCount || 0}
              </p>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">
                {formatPrice(transactionsData?.data?.summary?.netVolume || 0)}
              </p>
            </div>
          </div>
        </Card>
